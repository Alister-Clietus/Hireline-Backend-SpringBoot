...
import com.compiler.auth.dto.StudentPortalDTO;
...
import com.compiler.auth.repository.StudentPortalRepo;
...
public class RegistrationServiceImp implements RegistrationService
{
	...
	@Autowired
	StudentPortalRepo studentportalrepo;
...
//	****Questionair Registration Service Implementation****
	...
	public ServiceResponse addStudentPortalDetails(StudentPortalDTO studentportaldto)
	{
		try
		{
			if(studentportaldto.getUsername() == "") 
			{
				return new ServiceResponse(Constants.MESSAGE_STATUS.Fail,"Student Inserted UnSuceessfully",null);
				
			}else {
				Date currentDate = new Date();
				String encodedPassword = passwordEncoder.encode(studentportaldto.getPassword());
				RegistrationEntity entity = new RegistrationEntity();
				StudentPortalEntity entity1 = new StudentPortalEntity();
				
				if (studentportaldto.getFirstName() != null && studentportaldto.getLastName() != null) 
				{
		            String username = (studentportaldto.getFirstName() + studentportaldto.getLastName())
		                    .toLowerCase()
		                    .replaceAll("\\s+", ""); 
				...
				entity.setFullname(studentportaldto.getFirstName());
				entity.setEmail(studentportaldto.getEmail());
				entity.setPhoneNumber(studentportaldto.getPhoneNumber());
				entity.setCollege(studentportaldto.getCollegename());
				entity.setBranch("Branch");
				entity.setKtuId(studentportaldto.getKtuId());
				entity.setCdate(currentDate);
				entity.setGender(studentportaldto.getGender());
				entity.setPassword(encodedPassword);
				entity.setUserType("STUDENTPORTAL");
				entity.setStatus("PROCESSD");
				entity.setTotalMarks("0");
				// Personal Details
				entity1.setFirstName(studentportaldto.getFirstName());
				entity1.setLastName(studentportaldto.getLastName());
				entity1.setPhoneNumber(studentportaldto.getPhoneNumber());
				entity1.setGender(studentportaldto.getGender());
				entity1.setHousename(studentportaldto.getCollegename()); // Assuming house name and college name are the same field
				entity1.setPincode(studentportaldto.getPincode());

			    // College Details
				entity1.setCurrentSemester(studentportaldto.getCurrentSemester());
				entity1.setCurrentCgpa(studentportaldto.getCurrentCgpa());
				entity1.setKtuId(studentportaldto.getKtuId());

			    // Authentication Details
				entity1.setEmail(studentportaldto.getEmail());
				entity1.setPassword(studentportaldto.getPassword());

			    // Education Details
				entity1.setHighSchoolCourse(studentportaldto.getHighSchoolCourse());
				entity1.setHighSchoolCollege(studentportaldto.getHighSchoolCollege());
				entity1.setHighSchoolGraduationYear(studentportaldto.getHighSchoolGraduationYear());

				entity1.setHigherSecondaryCourse(studentportaldto.getHigherSecondaryCourse());
				entity1.setHigherSecondaryCollege(studentportaldto.getHigherSecondaryCollege());
				entity1.setHigherSecondaryGraduationYear(studentportaldto.getHigherSecondaryGraduationYear());

				entity1.setGraduationDegree(studentportaldto.getGraduationDegree());
				entity1.setGraduationCollege(studentportaldto.getGraduationCollege());
				entity1.setGraduationGraduationYear(studentportaldto.getGraduationGraduationYear());

			    // Projects
				entity1.setMiniProjectName(studentportaldto.getMiniProjectName());
				entity1.setMiniProjectStack(studentportaldto.getMiniProjectStack());
				entity1.setMiniProjectYear(studentportaldto.getMiniProjectYear());

				entity1.setMainProjectName(studentportaldto.getMainProjectName());
				entity1.setMainProjectStack(studentportaldto.getMainProjectStack());
				entity1.setMainProjectYear(studentportaldto.getMainProjectYear());

				entity1.setPersonalProjectName(studentportaldto.getPersonalProjectName());
				entity1.setPersonalProjectStack(studentportaldto.getPersonalProjectStack());
				entity1.setPersonalProjectYear(studentportaldto.getPersonalProjectYear());

			    // Frameworks, Languages & Skills
				entity1.setFrameworksKnown1(studentportaldto.getFrameworksKnown1());
				entity1.setFrameworksKnown2(studentportaldto.getFrameworksKnown2());
				entity1.setFrameworksKnown3(studentportaldto.getFrameworksKnown3());

				entity1.setProgrammingLanguages1(studentportaldto.getProgrammingLanguages1());
				entity1.setProgrammingLanguages2(studentportaldto.getProgrammingLanguages2());
				entity1.setProgrammingLanguages3(studentportaldto.getProgrammingLanguages3());

				entity1.setLanguagesKnown1(studentportaldto.getLanguagesKnown1());
				entity1.setLanguagesKnown2(studentportaldto.getLanguagesKnown2());
				entity1.setLanguagesKnown3(studentportaldto.getLanguagesKnown3());

			    // Hobbies & Achievements
				entity1.setHobbies1(studentportaldto.getHobbies1());
				entity1.setHobbies2(studentportaldto.getHobbies2());
				entity1.setHobbies3(studentportaldto.getHobbies3());

				entity1.setAchievements1(studentportaldto.getAchievements1());
				entity1.setAchievements2(studentportaldto.getAchievements2());
				entity1.setAchievements3(studentportaldto.getAchievements3());

				entity1.setSoftSkills1(studentportaldto.getSoftSkills1());
				entity1.setSoftSkills2(studentportaldto.getSoftSkills2());
				entity1.setSoftSkills3(studentportaldto.getSoftSkills3());
